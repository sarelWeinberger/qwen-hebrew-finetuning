...
6. Cultural adaptation for rare activities: If the activity or context involves something very rare or unfamiliar in Israeli culture (like lacrosse, specific American transit systems, or highly location-specific activities), perform transcreation instead of direct english_to_hebrew_translation - replace the acticity with a similar Israeli equivalent that maintains the same logical structure.
</instruction>"""

GSM_INSTRUCT_CLAUDE_REFINE_V1 = """<instruction>
Your task is to translate the given English question and possible answers into Hebrew. First write a possible english_to_hebrew_translation, then improve it. 
Follow these guidelines for the final english_to_hebrew_translation:
