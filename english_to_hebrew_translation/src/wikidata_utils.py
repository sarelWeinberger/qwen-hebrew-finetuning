...
if __name__ == '__main__':
    ...
    if hebrew_translation and "he" in hebrew_translation:
        ...
        print(f"\nCould not retrieve the Hebrew english_to_hebrew_translation and description for '{english_term}'.")
...
def wikidata_gradio():
    ...
    iface = gr.Interface(
     ...
     description="Enter a term and click 'Run' to see the english_to_hebrew_translation."
    )
