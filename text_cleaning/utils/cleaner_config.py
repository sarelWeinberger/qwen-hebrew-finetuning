...
duplicate_cleaner_registry: Dict[str, DuplicateCleaner] = {
    source: DuplicateCleaner() for source in SOURCES
}
...
duplicate_cleaners: List[DuplicateCleaner] = list(duplicate_cleaner_registry.values())
