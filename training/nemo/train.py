...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, required=False, default='Qwen3_8B', choices=['Qwen3_8B', 'Qwen3_30B_A3B_Base', 'Aya_8B', 'Aya_32B'], help="Which model to train - assumes you already imported the base model from huggingface")
    ...
    elif args.model == 'Aya_8B':
        model = aya_llm.aya_expanse_8b
        tp, cp, pp = 2, 1, 1
        micro_bs = 4
        model_name = 'CohereLabs/aya-expanse-8b'
    elif args.model == 'Aya_32B':
        model = aya_llm.aya_expanse_32b
        tp, cp, pp = 4, 1, 2
        micro_bs = 4
