...
Hebrew:
<question>באפריל, טאנק אספה 10 ביצי פסחא יותר מאמה בסבב ציד הביצים הראשון שלהם. עם זאת, אמה אספה פי שניים ביצים מטאנק בסבב השני שלהן של ציד הביצים, בעוד שהמספר הכולל של הביצים של טאנק בסבב השני היה 20 פחות מהמספר שהיא אספה בסבב הראשון. אם סך כל הביצים בערימה שהן אספו יחד עם 6 אנשים נוספים היה 400 ביצים, ואמה אספה 60 ביצים בסבב ציד הביצים השני, מצאו את מספר הביצים שאספו 6 ציידי הביצים האחרים?</question>
<answer>מספר ביצי הפסחא הכולל של טאנק בסיבוב השני היה 60/2=<<60/2=30>>30 מכיוון שאמה אספה פי שניים ביצים יותר מטאנק בסיבוב השני שלהן בציד הביצים.
סך כל ביצי הפסחא שאמה וטאנק אספו בסיבוב השני היה 60+30=<<60+30=90>>90
סך כל ביצי הפסחא של טאנק בסיבוב השני היה 20 פחות מהמספר שהיא אספה בסיבוב הראשון, כלומר היא אספה 30+20=<<30+20=50>>50 ביצים בסיבוב הראשון של ציד הביצים.
טאנק אספה 10 ביצי פסחא יותר מאמה בסיבוב הראשון שלהן בציד הביצים, כלומר אמה אספה 50-10=40 ביצי פסחא
סך כל ביצי הפסחא שאמה וטאנק אספו בסיבוב הראשון היה 40+50=<<40+50=90>>90
בשני הסבבים, אמה וטאנק אספו 90+90=<<90+90=180>>180 ביצי פסחא
...
<answer>וונג מרוויחה 12/60 = $<<12/60=0.2>>0.2 לדקה.
...
<answer>בהתחלה, לבטי יש רק 100 / 2 = $<<100/2=50>>50.
...
<answer>מיילה קראה 12 × 2 = <<12*2=24>>24 עמודים היום.
