...
Hebrew:
<activity_label>הסרת קרח מהרכב</activity_label>
...
<ctx_b>מתחילה ל</ctx_b>
<ctx>אישה נמצאת במטבח ומכינה ארוחת צהריים. היא מוציאה לחם ומרכיבים שונים. היא מתחילה ל</ctx>
<ending 1>למרוח חמאת בוטנים על פרוסות הלחם.</ending 1>
<ending 2>לצבוע את קירות המטבח.</ending 2>
<ending 3>להתרגל לנגן בפסנתר.</ending 3>
<ending 4>לשטוף את הרכב שלה בחניה.</ending 4>
</example>
...
Hebrew:
<activity_label>משחק כדורגל</activity_label>
<ctx_a>ילדים משחקים כדורגל בשדה. הכדור נבעט לכיוון השער. השוער</ctx_a>
<ctx_b>קופץ כדי</ctx_b>
<ctx>ילדים משחקים כדורגל בשדה. הכדור נבעט לכיוון השער. השוער קופץ כדי</ctx>
<ending 1>לתפוס את הכדור בידיים.</ending 1>
...
<ctx_a>אדם עומד ליד כיור המטבח אחרי ארוחת הערב. יש ערימה של כלים מלוכלכים. הם</ctx_a>
<ctx_b>פותחים את</ctx_b>
<ctx>אדם עומד ליד כיור המטבח אחרי ארוחת הערב. יש ערימה של כלים מלוכלכים. הם פותחים את</ctx>
<ending 1>הברז ומתחילים לשטוף את הכלים עם סבון.</ending 1>
<ending 2>הטלוויזיה כדי לצפות בחדשות.</ending 2>
<ending 3>מכסחת הדשא כדי לגזוז את הדשא.</ending 3>
...
<ctx_a>ילד מתכונן ללכת לישון. הם הולכים לחדר הרחצה ולוקחים את מברשת השיניים שלהם. הם</ctx_a>
<ctx_b>סוחטים את</ctx_b>
<ctx>ילד מתכונן ללכת לישון. הם הולכים לחדר הרחצה ולוקחים את מברשת השיניים שלהם. הם סוחטים את</ctx>
<ending 1>משחת השיניים על המברשת ומתחילים לצחצח את השיניים.</ending 1>
<ending 2>מיץ התפוזים לתוך כוס.</ending 2>
<ending 3>הכרית כדי להפוך אותה לנוחה יותר.</ending 3>
